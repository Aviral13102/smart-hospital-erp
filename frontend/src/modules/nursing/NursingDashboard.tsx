...
import { UserCog, Calendar, Clock, Plus, LogIn, LogOut, RefreshCw } from 'lucide-react';
...
const demoStaff: Staff[] = [
    { id: 1, employeeId: 'NUR-001', firstName: 'Mary', lastName: 'Wilson', role: 'NURSE', department: 'ICU', ward: 'ICU', phone: '+1-555-0201', status: 'ACTIVE' },
    ...
];
*/
